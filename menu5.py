...
class MENU5():
	...
	def draw(self):
		...
		if len(self.levels) >= 4:
			...
			self.tekst1 = text(self.screen,245,490,"Ostrowek",self.font_color,32)
		else:
			pygame.draw.rect(self.screen,self.lock_color,(200, 400, 300, 200))
			self.tekst1 = text(self.screen,245,490,"Ostrowek",self.lock_font_color,32)

		if len(self.levels) >= 5:
			pygame.draw.rect(self.screen,self.color,(700, 400, 300, 200))
			self.tekst2 = text(self.screen,780,490,"Torun",self.font_color,32)
		else:
			pygame.draw.rect(self.screen,self.lock_color,(700, 400, 300, 200))
			self.tekst2 = text(self.screen,780,490,"Torun",self.lock_font_color,32)
		...
		if len(self.levels) >= 6:
			...
			self.tekst3 = text(self.screen,1255,490,"Poludnie",self.font_color,32)
		else:
			pygame.draw.rect(self.screen,self.lock_color,(1200,400,300,200))
			self.tekst3 = text(self.screen,1255,490,"Poludnie",self.lock_font_color,32)
