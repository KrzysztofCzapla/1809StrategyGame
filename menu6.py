...
class MENU6():
	...
	def draw(self):
		...
		self.tekst1 = text(self.screen,250,490,"borodino",self.font_color,32)


		if len(self.levels) >= 8:
			pygame.draw.rect(self.screen,self.color,(700, 400, 300, 200))
			self.tekst2 = text(self.screen,775,490,"leipzig",self.font_color,32)
		else:
			pygame.draw.rect(self.screen,self.lock_color,(700, 400, 300, 200))
			self.tekst2 = text(self.screen,775,490,"leipzig",self.lock_font_color,32)
		...
		if len(self.levels) >= 9:
			...
			self.tekst3 = text(self.screen,1250,490,"Waterloo",self.font_color,32)
		else:
			pygame.draw.rect(self.screen,self.lock_color,(1200,400,300,200))
			self.tekst3 = text(self.screen,1250,490,"Waterloo",self.lock_font_color,32)
